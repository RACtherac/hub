...
export const thousandSonsUnits: Unit[] = [

  {
    ...
    category: "mounted",
    points: 45,
    pointsByModelCount: { 3: 45, 6: 90 },
    modelCountOptions: [3, 6],
    defaultWargear: [],
    wargear: [
      {
        id: "tzaangor-divining-spear",
        name: "Divining spear",
        image: "",
        countable: true,
        maxCountByModelCount: { 3: 3, 6: 6 },
        maxCountReducedByWargear: ["tzaangor-autopistol"],
        profiles: [{ range: "Melee", attacks: "3", skill: "4+", strength: "5", ap: "-1", damage: "2", keywords: ["LANCE", "PRECISION"] }],
      },
      {
        id: "tzaangor-autopistol",
        name: "Autopistol",
        image: "",
        countable: true,
        maxCountByModelCount: { 3: 3, 6: 6 },
        maxCountReducedByWargear: ["tzaangor-divining-spear"],
        linkedCounterId: "tzaangor-chainsword",
        profiles: [{ range: '12"', attacks: "1", skill: "4+", strength: "3", ap: "0", damage: "1", keywords: ["PISTOL"] }],
      },
      {
        id: "tzaangor-chainsword",
        name: "Chainsword",
        image: "",
        countable: true,
        maxCountByModelCount: { 3: 3, 6: 6 },
        linkedCounterId: "tzaangor-autopistol",
        profiles: [{ range: "Melee", attacks: "6", skill: "4+", strength: "4", ap: "0", damage: "1", keywords: ["PRECISION"] }],
      },
    ],
    abilities: [
      {
    ...
    ledBy: ["ahriman", "exalted-sorcerer-on-disc-of-tzeentch", "tzaangor-shaman"],
  },
...

  {
    ...
    defaultWargear: [
      {
        id: "scarab-inferno-combi-bolter",
        name: "Inferno combi-bolter",
        image: "",
        profiles: [{ range: '24"', attacks: "2", skill: "3+", strength: "4", ap: "-2", damage: "1", keywords: ["RAPID FIRE 2"] }],
      },
      {
        id: "scarab-malefic-curse",
        name: "Malefic Curse",
        image: "",
        profiles: [{ range: '24"', attacks: "3", skill: "3+", strength: "4", ap: "-3", damage: "1", keywords: ["ANTI-INFANTRY 4+", "DEVASTATING WOUNDS", "PSYCHIC"] }],
      },
      {
        id: "scarab-force-weapon",
        name: "Force weapon",
        image: "",
        profiles: [{ range: "Melee", attacks: "4", skill: "3+", strength: "6", ap: "-1", damage: "D3", keywords: ["PSYCHIC"] }],
      },
    ],
    wargear: [
      {
        id: "scarab-hellfyre-missile-rack",
        name: "Hellfyre missile rack",
        image: "",
        countable: true,
        maxCountByModelCount: { 5: 1, 10: 2 },
        profiles: [{ range: '36"', attacks: "2", skill: "3+", strength: "10", ap: "-2", damage: "3" }],
      },
      {
        id: "scarab-heavy-warpflamer",
        name: "Heavy warpflamer",
        image: "",
        countable: true,
        maxCountByModelCount: { 5: 1, 10: 2 },
        maxCountReducedByWargear: ["scarab-soulreaper-cannon"],
        profiles: [{ range: '12"', attacks: "D6", skill: "N/A", strength: "5", ap: "-2", damage: "1", keywords: ["IGNORES COVER", "TORRENT"] }],
      },
      {
        id: "scarab-soulreaper-cannon",
        name: "Soulreaper cannon",
        image: "",
        countable: true,
        maxCountByModelCount: { 5: 1, 10: 2 },
        maxCountReducedByWargear: ["scarab-heavy-warpflamer"],
        profiles: [{ range: '24"', attacks: "6", skill: "3+", strength: "6", ap: "-2", damage: "1", keywords: ["DEVASTATING WOUNDS"] }],
      },
      {
        id: "sgt-scarab-inferno-combi-bolter",
        name: "Inferno combi-bolter",
        image: "",
        sergeantOnly: true,
        profiles: [{ range: '24"', attacks: "2", skill: "3+", strength: "4", ap: "-2", damage: "1", keywords: ["RAPID FIRE 2"] }],
      ...
      {
        id: "sgt-prosperine-khopesh",
        name: "Prosperine khopesh",
        image: "",
        sergeantOnly: true,
        profiles: [{ range: "Melee", attacks: "3", skill: "3+", strength: "5", ap: "-2", damage: "2" }],
      },
    ],
    wargearGroups: [["sgt-scarab-inferno-combi-bolter", "sgt-prosperine-khopesh"]],
    abilities: [
      {
    ...
    ledBy: ["sorcerer-in-terminator-armour"],
  },
